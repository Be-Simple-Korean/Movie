package com.example.movie.ui.component.dialog.components.buttons
...
@Composable
fun DialogButtonsCustom(buttons: List<DialogButton>?) {
    Column(
        ...
        buttons?.forEachIndexed { index, dialogButton ->
            ...
            when (dialogButton) {
                is DialogButton.Primary -> {
                    PrimaryButton(text = dialogButton.title, leadingIconData = dialogButton.leadingIconData) {
